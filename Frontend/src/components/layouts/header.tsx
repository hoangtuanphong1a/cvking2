      ...
      >
        ...
        <div className="flex items-center gap-2 lg:hidden">
          ...
          <div className="relative group">
            <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground group-focus-within:text-orange-600 transition-all duration-200" />
            <Input
              placeholder="Tìm bài viết, tag, tác giả..."
              className={cn(
                "pl-10 pr-4 py-2 h-10 bg-gray-50 border-border rounded-full",
                "focus-visible:ring-2 focus-visible:ring-orange-500/30 focus-visible:border-orange-500",
        ...
        <div className="lg:hidden">
          {isAuthenticated ? (
            ...
            <Link href={ROUTES.LOGIN}>
              <Button
                className="min-w-[110px] text-orange-600 hover:bg-orange-400 hover:text-orange-800"
                variant="outline"
              >
                Đăng nhập
              </Button>
        ...
        <div className="hidden flex-1 lg:flex justify-center">
          <div className="relative group max-w-md w-full">
            <Search className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-muted-foreground group-focus-within:text-orange-600 transition-all duration-300" />
            <Input
              placeholder="Tìm kiếm bài viết, tag, tác giả..."
              className={cn(
                "pl-12 pr-5 py-3 h-12 bg-gray-50/80 backdrop-blur-sm border-border rounded-full",
                "focus-visible:ring-0 focus-visible:border-orange-500 focus-visible:bg-white",
          ...
          {!isAuthenticated ? (
            <div className="flex items-center space-x-2">
              ...
              <Link href={ROUTES.REGISTER}>
                <Button className="min-w-[110px] bg-orange-600 hover:bg-orange-400">
                  Đăng ký
                </Button>
              </Link>
            </div>
